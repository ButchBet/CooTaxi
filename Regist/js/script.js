...
document.addEventListener("DOMContentLoaded", () =>{
    ...
    createAccount.addEventListener("submit", e => {
        ...
        if(counter === 0) {
            ...
            formMessageSetting(createAccount, "Error", "The user name already exists");

            formMessageDelete(createAccount);
        } else if(counter === 2) {
            formMessageSetting(createAccount, "Error", "The email already exists")

            formMessageDelete(createAccount);
        } else if(counter === 3) {
            formMessageSetting(createAccount, "Error", "The user name and email already exist")
            ...
            formMessageSetting(createAccount, "Error", "The passwords don't match, the user name and email already exist")
